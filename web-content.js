(function () {
    ...
    async function runSummary() {
        ...
        try {
            ...
            setStatus(text, 'ok summary-output');
        } catch (error) { setStatus(error.message || String(error), 'error'); }
        finally { state.busy = false; }
    }
